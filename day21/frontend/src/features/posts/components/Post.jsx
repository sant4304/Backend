          ...
          <div className="post">
            <div className="user">
              <div className="img-wrapper">
                <img
                  src="https://images.unsplash.com/photo-1783882510259-4d32906d5164?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                  alt=""
                />
              </div>
              <p>Username</p>
            ...
            <img
              src="https://images.unsplash.com/photo-1787894653068-bf1eeb927af4?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHx0b3BpYy1mZWVkfDIzfHRvd0paRnNrcEdnfHxlbnwwfHx8fHw%3D"
              alt=""
            />
            <div className="icons">
                <div className="left">
